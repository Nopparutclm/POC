...
var isFigmaURL = function (url) { return exports.figmaURLPattern.test(url); };
exports.isFigmaURL = isFigmaURL;
var Figma = function (_a) {
    var config = _a.config;
    var iframeConfig = (0, react_1.useMemo)(function () {
        var isValid = (0, exports.isFigmaURL)(config.url);
        if (!isValid) {
        ...
        var url = "https://www.figma.com/embed?embed_host=".concat(embedHost, "&url=").concat(config.url);
        return {
            url: url,
            allowFullscreen: config.allowFullscreen,
        };
    }, [config.url, config.allowFullscreen, config.embedHost]);
    return (0, theming_1.jsx)(IFrame_1.IFrame, { defer: true, config: iframeConfig });
};
exports.Figma = Figma;
