...
var fullscreen = (0, theming_1.css)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n"], ["\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n"])));
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    nodeUrl = new URL("https://api.figma.com/v1/files/".concat(fileKey));
                    imageUrl = new URL("https://api.figma.com/v1/images/".concat(fileKey));
                    imageUrl.searchParams.set("format", "svg");
                    if (!!nodeId) return [3, 4];
                    return [4, fetch(nodeUrl.href, {
                            headers: headers,
                            signal: signal,
                        }).then(function (resp) { return unwrapJson(resp); })];
                case 2:
                ...
                case 4:
                    ...
                    return [4, Promise.all([
                            ...
                            fetch(imageUrl.href, { headers: headers, signal: signal }).then(function (resp) {
    ...
    switch (state.state) {
        case "loading":
            return ((0, theming_1.jsx)(components_1.Placeholder, null,
                (0, theming_1.jsx)(react_1.Fragment, null, "Loading Figma file...")));
        case "failed":
            return ((0, theming_1.jsx)(components_1.Placeholder, null,
                (0, theming_1.jsx)(react_1.Fragment, null, "Failed to load Figma file"),
                (0, theming_1.jsx)(react_1.Fragment, null, state.error)));
        case "fetched":
            return state.value.type === "file" ? ((0, theming_1.jsx)(react_2.FigspecFileViewer, __assign({ css: fullscreen }, state.value.props))) : ((0, theming_1.jsx)(react_2.FigspecFrameViewer, __assign({ css: fullscreen }, state.value.props)));
    }
};
...
function listAllFrames(node) {
    ...
    return node.children.map(listAllFrames).reduce(function (a, b) { return a.concat(b); }, []);
}
